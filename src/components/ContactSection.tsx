...
export const ContactSection: React.FC = () => {
  ...
  const handleSubmit = (e: React.FormEvent) => {
    ...
    setSubmitting(true);
    // Simulate prompt inquiry submission
    setTimeout(() => {
      setSubmitting(false);
      setIsSubmitted(true);
    }, 600);
  ...
  const mapsQuery = encodeURIComponent(
    'Bag E Hussain Chowk, Pira Gaib Road, Samijabad, Multan, Pakistan'
  );
  const mapsUrl = `https://www.google.com/maps/search/?api=1&query=${mapsQuery}`;

  return (
    <section className="bg-[#F9F9F9] py-16 lg:py-24 border-b border-gray-100" id="contact">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="max-w-3xl mb-12">
          ...
          <h2 className="text-2xl sm:text-3xl lg:text-4xl font-light text-[#0A3D62] tracking-tight">
            ...
            <span className="font-bold italic font-serif">& Dental Complex</span>
          </h2>
          <div className="w-12 h-0.5 bg-[#0A3D62] my-3" />
          <p className="text-[#636E72] text-xs sm:text-sm">
            We welcome visiting patients and inquiries regarding outpatient medical consultations, blood pressure checks, injections, and dental appointments in Multan.
          </p>
        </div>
        ...
        <div className="grid grid-cols-1 lg:grid-cols-12 gap-10 items-start">
            ...
            <div className="bg-white p-6 rounded-sm border border-gray-100 shadow-2xs space-y-3">
              ...
              <div className="space-y-2 pt-1">
                <div className="flex items-center justify-between p-3 bg-[#F9F9F9] rounded-sm border border-gray-100">
                  <div>
                    <span className="text-[9px] uppercase font-bold tracking-wider text-gray-400 block">Landline</span>
                    <a
                ...
                <div className="flex items-center justify-between p-3 bg-[#F9F9F9] rounded-sm border border-gray-100">
                  <div>
                    <span className="text-[9px] uppercase font-bold tracking-wider text-gray-400 block">Mobile Contact</span>
                    <a
            ...
            <div className="bg-white p-6 rounded-sm border border-gray-100 shadow-2xs space-y-3">
              ...
              <div className="space-y-1.5 text-xs">
                <p className="flex items-center gap-2 text-[#636E72]">
                  <span className="font-semibold text-gray-400">Official HR:</span>
                  <a
                ...
                <p className="flex items-center gap-2 text-[#636E72]">
                  <span className="font-semibold text-gray-400">Additional:</span>
                  <a
          ...
          <div className="lg:col-span-7 bg-white p-6 sm:p-8 rounded-sm border border-gray-100 shadow-2xs">
            ...
            <p className="text-xs text-[#636E72] mb-6">
              Leave your contact details and message below. For urgent clinical queries, please call directly at 061-6560560.
            </p>
            ...
            {isSubmitted ? (
              <div className="p-6 bg-[#E8F1F8] border border-sky-200 rounded-sm text-center space-y-3">
                ...
                <p className="text-xs text-[#0A3D62] max-w-md mx-auto leading-relaxed">
                  Thank you, <strong className="font-semibold">{formData.name}</strong>. Our hospital reception desk at Rasheed Hospital & Dental Complex will review your inquiry.
                </p>
                <button
                  type="button"
                  onClick={() => {
              ...
              <form onSubmit={handleSubmit} className="space-y-4">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-4">
                  {/* Name */}
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-[#0A3D62] mb-1" htmlFor="patient-name">
                  ...
                  {/* Phone */}
                  <div>
                    <label className="block text-xs font-bold uppercase tracking-wider text-[#0A3D62] mb-1" htmlFor="patient-phone">
                ...
                {/* Service of Interest */}
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-[#0A3D62] mb-1" htmlFor="service-select">
                    Service Required
                  </label>
                  <select
                    id="service-select"
                    ...
                    className="w-full px-3.5 py-2.5 text-xs bg-[#F9F9F9] border border-gray-200 rounded-sm focus:bg-white focus:outline-hidden focus:border-[#0A3D62] transition-all"
                  >
                    <option value="Medical Consultation / OPD">Medical Consultation / Outpatient OPD</option>
                    <option value="Dental Care & Procedures">Dental Care & Dental Procedures</option>
                    <option value="Blood Pressure Checking">Blood Pressure Check & Monitoring</option>
                    <option value="Injections & IV / Drip Care">Injections & IV / Drip Care</option>
                    <option value="Prescription & Medical Guidance">Prescription & Medical Guidance</option>
                    <option value="Basic Medicines Availability">Basic Medicines Inquiry</option>
                  </select>
                </div>

                {/* Message */}
                <div>
                  <label className="block text-xs font-bold uppercase tracking-wider text-[#0A3D62] mb-1" htmlFor="patient-message">
